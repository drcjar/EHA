topojson = function() {
  function e( e, n ) {
    ...
    n.forEach( function( e ) {
      ...
      if ( n = o[ u ] )
        ...
        var s = n.concat( a.map( function( e ) {
          return~ e
        } ).reverse() );
  ...
  function n( n, t, r ) {
    ...
    function c( e ) {
      "GeometryCollection" === e.type ? e.geometries.forEach( c ) : e.type in d && ( f = e, d[ e.type ]( e.arcs ) )
    }
    var s = [];
    if ( arguments.length > 1 ) {
      ...
      c( t ), l.forEach( arguments.length < 3 ? function( e, n ) {
        s.push( n )
      } : function( e, n ) {
        r( e[ 0 ], e[ e.length - 1 ] ) && s.push( n )
      } )
    } else
      for ( var p = 0, v = n.arcs.length; v > p; ++p ) s.push( p );
    return o( n, {
  ...
  function o( e, n ) {
    function t( e, n ) {
      n.length && n.pop();
      for ( var t, r = f[ 0 > e ? ~e : e ], o = 0, i = r.length; i > o; ++o ) n.push( t = r[ o ].slice() ), s( t, o );
      0 > e && a( n, i )
    }
  ...
  function a( e, n ) {
    for ( var t, r = e.length, o = r - n; o < --r; ) t = e[ o ], e[ o++ ] = e[ r ], e[ r ] = t
  }
    ...
    for ( var c in o )
      for ( var s = o[ c ], f = s.length, l = 0; f > l; ++l )
        for ( var d = l + 1; f > d; ++d ) {
          var p, v = s[ l ],
            h = s[ d ];
          ( p = a[ v ] )[ c = i( p, h ) ] !== h && p.splice( c, 0, h ), ( p = a[ h ] )[ c = i( p, v ) ] !== v && p.splice( c, 0, v )
        }
    return a
  }
  ...
  function c( e, n ) {
    ...
    var r, o = d( e.transform ),
      a = p( e.transform ),
      i = l( f ),
      u = 0;
    for ( n || ( n = s ), e.arcs.forEach( function( e ) {
      var t = [];
      e.forEach( o );
      for ( var a = 1, u = e.length - 1; u > a; ++a ) r = e.slice( a - 1, a + 2 ), r[ 1 ][ 2 ] = n( r ), t.push( r ), i.push( r );
      e[ 0 ][ 2 ] = e[ u ][ 2 ] = 1 / 0;
      for ( var a = 0, u = t.length; u > a; ++a ) r = t[ a ], r.previous = t[ a - 1 ], r.next = t[ a + 1 ]
    } ); r = i.pop(); ) {
      var c = r.previous,
        v = r.next;
      r[ 1 ][ 2 ] < u ? r[ 1 ][ 2 ] = u : u = r[ 1 ][ 2 ], c && ( c.next = v, c[ 2 ] = r[ 2 ], t( c ) ), v && ( v.previous = c, v[ 0 ] = r[ 0 ], t( v ) )
    }
  ...
  function s( e ) {
    return Math.abs( ( e[ 0 ][ 0 ] - e[ 2 ][ 0 ] ) * ( e[ 1 ][ 1 ] - e[ 0 ][ 1 ] ) - ( e[ 0 ][ 0 ] - e[ 1 ][ 0 ] ) * ( e[ 2 ][ 1 ] - e[ 0 ][ 1 ] ) )
  }
  ...
  function l( e ) {
    ...
    function t( n ) {
      for ( var t = o[ n ];; ) {
        var r = n + 1 << 1,
          ...
          i = n,
          u = o[ i ];
        if ( a < o.length && e( o[ a ], u ) < 0 && ( u = o[ i = a ] ), r < o.length && e( o[ r ], u ) < 0 && ( u = o[ i = r ] ), i === n ) break;
    ...
    return r.push = function() {
      ...
      var a = r.index,
        i = o.pop();
      return a !== o.length && ( o[ i.index = a ] = i, ( e( i, r ) < 0 ? n : t )( a ) ), a
    }, r
  }
  ...
  function d( e ) {
    ...
    var n, t, r = e.scale[ 0 ],
      ...
      i = e.translate[ 1 ];
    return function( e, u ) {
      u || ( n = t = 0 ), e[ 0 ] = ( n += e[ 0 ] ) * r + a, e[ 1 ] = ( t += e[ 1 ] ) * o + i
    }
  }
